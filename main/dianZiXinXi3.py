...
def last(num1,num2,fname):
    ...
    for i in range(num1,num2):
        ...
        try:
            resp = request.urlopen(url, timeout=80)
            # print(resp.getcode())
...
# last(4001,5001,"../resource/dianZiXinXi5.xls")
# last(5001,6001,"../resource/dianZiXinXi6.xls")
# last(6001,7001,"../resource/dianZiXinXi7.xls")
last(7001,8001,"../resource/dianZiXinXi8.xls")
last(8001,9001,"../resource/dianZiXinXi9.xls")
# last(9001,10001,"../resource/dianZiXinXi10.xls")
# last(10001,11001,"../resource/dianZiXinXi11.xls")
# last(11001,12001,"../resource/dianZiXinXi12.xls")
# last(12001,13001,"../resource/dianZiXinXi13.xls")
# last(13001,14001,"../resource/dianZiXinXi14.xls")
# last(14001,15001,"../resource/dianZiXinXi15.xls")
# last(15001,16171,"../resource/dianZiXinXi16.xls")
